...
`0.4.0-rc.12`は公開RC（リリース候補版）です。実行機能は初期状態で無効です。

![Sol・Terra・Lunaの役割と参考配分](https://raw.githubusercontent.com/Miraigent/openclaw-model-router-mcp/main/assets/sol-terra-luna-standard-allocation-cost-diagram-2026-07-10.png)
